...
<br/> <br/>
Right now my primary focus is on experimenting with OpenAI's GPT-5.5, Google's Gemini 3.1 Pro Preview, Minimax M2.7 and Anthropic's Claude Fable 5 as well as other new AI models and finding out how to best utilize it for web development, coding assistance, vector databases, RAG, Langchain, embeddings, online research, implementing it with AI-based online applications, such as https://github.com/w3bdesign/spotify-import and a lot more (most are in private repos)!
